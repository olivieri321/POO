...
public class ListaDeTareasMejorada {
    ...
    public ListaDeTareasMejorada clonar() {
        ListaDeTareasMejorada nuevaLista = new ListaDeTareasMejorada();
        NodoTarea actual = this.recuperarTareasporPrioridad();
        while (actual != null) {
    ...
    public NodoTarea recuperarTareasporPrioridad(){
        return this.tareaConPrioridad;
    }

    public NodoTarea recuperarTareasVencidas(){
    ...
    public void agregarTarea(Tarea tarea){
        NodoTarea nuevaTarea= new NodoTarea(tarea);
        if (this.esVacia()){
