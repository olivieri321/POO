...
public class Venta {
    ...
    public Venta(LocalDate fecha, Expendedor expendedor , float litros, String dniEmpleado, double descuento) {
        this.fecha = fecha;
        this.importeTotal = (expendedor.getPrecioCombustible() * litros)*descuento ;
        this.expendedor = expendedor;
        expendedor.expender(litros);
        this.dniEmpleado = dniEmpleado;
    }
